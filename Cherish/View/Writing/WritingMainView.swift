...
extension WritingMainView {
    ...
    private func Title() -> some View {
        ...
        .frame(height: 20)
        .paddingHorizontal()
        .padding(.bottom, getDeviceScreenHeight() == .small ? 26 : ( getDeviceScreenHeight() == .middle ? 35 : 49) )
        .foregroundColor(Color.gray23)
        .font(.timeLineTitle)
        .padding(.top, 26)
    }
    ...
    private func OneSentence() -> some View {
        ...
        .background(Color.grayF5)
        .cornerRadius(10)
        .padding(.bottom, getDeviceScreenHeight() == .small ? 0 :25)
            ...
            HStack(spacing: 0) {
                ...
                ForEach(cardSequence.indices, id: \.self){ index in
                    ...
                    GeometryReader { geomitry in
                        ...
                        .frame(width: width, height: width*1.5)
                        .cornerRadius(10)
                        .offset(x: width/4, y: getDeviceScreenHeight() == .small ? 35 : ( getDeviceScreenHeight() == .middle ? 45 : 50) )
